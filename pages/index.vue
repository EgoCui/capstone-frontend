<template>
  <my-slot class="home">
    <div class="t-con">
      ...
      <div class="content">
        ...
        <div class="right">
          ...
          <b-button class="fl-b" variant="outline-primary">Book Now</b-button>
        </div>
      </div>
    </div>
    <div class="t-con">
    ...
    <router-link to="/fundraising" class="nav-link">View full calendar</router-link>
  </div>
  ...
  <p style="text-align: left;"> <!-- Add CSS here -->
